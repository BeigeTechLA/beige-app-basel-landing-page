    ...
    >
      ...
      <div className="relative w-full">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-[3] flex flex-col items-center">
          ...
          >
            <Button className="w-[180px] h-[56px] rounded-full text-base font-medium bg-[#1A1A1A] text-white hover:bg-[#2A2A2A] border border-white/10">
              Book a Shoot
            </Button>
            <Button className="w-[200px] h-[56px] rounded-full text-base font-medium bg-[#ECE1CE] text-[#030303] hover:bg-[#dcb98a]">
