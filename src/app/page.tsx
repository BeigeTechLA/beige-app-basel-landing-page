...
import { ArrowRight, Zap, Users, Camera, Video, Menu, X } from "lucide-react";
...
const SERVICES = [
  {
    ...
    description:
      "Instantly match with the perfect creative based on your specific project needs, style, and budget.",
    icon: Zap,
  },
  {
    title: "Pre-Production",
    description:
      "Streamlined planning tools, mood boards, and scheduling to ensure your shoot runs flawlessly.",
    icon: Users,
  },
  {
    title: "Production",
    description:
      "On-set management and real-time coordination tools to keep everyone in sync.",
    icon: Camera,
  },
  {
    title: "Post-Production",
    description:
      "Seamless file transfer, review cycles, and final delivery management in one place.",
    icon: Video,
  },
];
      ...
      <div className="container mx-auto px-6 flex justify-center">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              href="https://beige.app/Auth/Login"
              className="text-sm font-medium text-white hover:text-[#ECE1CE] transition-colors"
            >
              Log in
            </a>
            <a
            ...
            >
              <Button className="bg-[#ECE1CE] text-black hover:bg-[#dcb98a] rounded-full px-6 h-9 text-sm font-semibold transition-transform hover:scale-105">
                Become An Investor
              </Button>
            </a>
          </div>
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <a
              href="https://beige.app/Auth/Login"
              className="text-lg font-medium text-white/80 hover:text-[#ECE1CE]"
            >
              Log in
            </a>
            <a
              ...
              className="w-full"
            >
              <Button className="w-full bg-[#ECE1CE] text-black">
                Become An Investor
              </Button>
            </a>
          </motion.div>
            ...
            <div className="absolute inset-0 bg-[#1a1a1a] rounded-[2rem] overflow-hidden border border-white/5">
              ...
              <div className="absolute bottom-8 left-8 p-6 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl max-w-xs">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-xs font-medium text-[#ECE1CE] uppercase tracking-widest">
                    Live Now
                  </span>
                </div>
                <p className="text-white text-sm leading-relaxed font-light">
                  &quot;The ecosystem for creators and brands to collaborate
                  seamlessly.&quot;
                </p>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2 space-y-12">
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="text-[#ECE1CE] text-xs font-mono uppercase tracking-widest">
                  Beige Media
                </span>
              </div>
              ...
              <p className="text-white/50 text-lg font-light max-w-lg leading-relaxed mb-10">
                From cultural moments and IRL streams to music videos, corporate
                events, weddings, and films—book the perfect photographer,
                videographer, or livestream creator in minutes through our
          ...
          <div className="flex flex-col items-center gap-16">
            ...
            >
              ...
              >
                ...
                <br />
                <span className="font-bold">Photography & Videography</span>
              </h1>
              ...
              <p className="text-lg text-white/50 max-w-xl mx-auto mb-10 font-light leading-relaxed">
                ...
                perfect creator for live streaming, videography, and photography
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 items-center justify-center">
                ...
                >
                  <a href="https://beige.app/cp-registration">
                    <Button
                      variant="outline"
                      className="bg-transparent border-white/20 text-white hover:bg-white hover:text-black h-12 px-8 rounded-full text-base font-medium backdrop-blur-sm transition-all"
                    >
                      Find Creative Work
                    </Button>
                  </a>
            ...
            {SERVICES.map((service, i) => (
              <a key={i} href="https://beige.app" className="block h-full">
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-4 group-hover:text-[#ECE1CE] transition-colors">
                    {service.title}
                  </h3>
